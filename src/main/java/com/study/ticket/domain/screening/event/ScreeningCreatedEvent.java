...
@Getter
@NoArgsConstructor
public class ScreeningCreatedEvent extends BaseEvent {

    private static final String EVENT_TYPE = "SCREENING_CREATED";
     ...
     */
    public ScreeningCreatedEvent(Screening screening) {
        super(EVENT_TYPE);
